...
parser.add_argument('--root_dir', type=str, default='/gpfs/u/home/LMTM/LMTMsmms/scratch/data/synthetic-cdm/synthetic_data/hparams/elite_global')
...
# Image
cub_dset = Imagelist(f'tmp_filelists/{args.source}.txt', transform=get_tensor_clip())
...
for i, batch in enumerate(loader):
    ...
    ret_imgs = validation(example, tokenizer, image_encoder, text_encoder, unet, mapper, vae, example["pixel_values_clip"].device, 5, 
                          token_index=token_index, seed=args.seed)
